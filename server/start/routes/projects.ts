...
Route.patch('project/:id', 'ProjectsController.update').middleware('auth')
...
Route.patch('project/task/:taskId/done', 'ProjectsController.setTaskDone').middleware('auth')
Route.patch('project/task/:taskId/unDone', 'ProjectsController.setTaskUndone').middleware('auth')
